...
namespace DynamicPanels {
  ...
  public class PanelManager : MonoBehaviour {
    ...
    private void InitializePreviewPanel() {
      RectTransform dynamicPanelPreview = null;
#if UNITY_EDITOR
      dynamicPanelPreview = Resources.Load<RectTransform>("DynamicPanelPreview");
#else
      dynamicPanelPreview = GameObject.Find("BTDebugInspector").GetComponent<DesignerData>().DynamicPanelPreview.GetComponent<RectTransform>();
#endif

      RectTransform previewPanel = Instantiate(dynamicPanelPreview);
